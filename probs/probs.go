...
func ProblemDetailsToStatusCode(prob *ProblemDetails) int {
	...
	switch prob.Type {
	case ConnectionProblem, MalformedProblem, TLSProblem, UnknownHostProblem, BadNonceProblem, InvalidEmailProblem, RejectedIdentifierProblem, AccountDoesNotExistProblem:
