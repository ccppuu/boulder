...
// TODO(@cpu): Move & comment this function. Putting it here for now to compare easily with NewCertificate
...
// TODO(@cpu) - Comment this function to describe what it does
