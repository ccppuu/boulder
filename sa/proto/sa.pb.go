...
It has these top-level messages:
	...
	OrderRequest
	OrdersByAuthzRequest
	OrdersByAuthzResponse
*/
package proto
...
type OrdersByAuthzRequest struct {
	Id               *string `protobuf:"bytes,1,opt,name=id" json:"id,omitempty"`
	XXX_unrecognized []byte  `json:"-"`
}

func (m *OrdersByAuthzRequest) Reset()                    { *m = OrdersByAuthzRequest{} }
func (m *OrdersByAuthzRequest) String() string            { return proto1.CompactTextString(m) }
func (*OrdersByAuthzRequest) ProtoMessage()               {}
func (*OrdersByAuthzRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{25} }

func (m *OrdersByAuthzRequest) GetId() string {
	if m != nil && m.Id != nil {
		return *m.Id
	}
	return ""
...
type OrdersByAuthzResponse struct {
	Orders           []*core.Order `protobuf:"bytes,1,rep,name=orders" json:"orders,omitempty"`
	XXX_unrecognized []byte        `json:"-"`
}

func (m *OrdersByAuthzResponse) Reset()                    { *m = OrdersByAuthzResponse{} }
func (m *OrdersByAuthzResponse) String() string            { return proto1.CompactTextString(m) }
func (*OrdersByAuthzResponse) ProtoMessage()               {}
func (*OrdersByAuthzResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{26} }

func (m *OrdersByAuthzResponse) GetOrders() []*core.Order {
	if m != nil {
		return m.Orders
	}
	return nil
...
func init() {
	...
	proto1.RegisterType((*OrdersByAuthzRequest)(nil), "sa.OrdersByAuthzRequest")
	proto1.RegisterType((*OrdersByAuthzResponse)(nil), "sa.OrdersByAuthzResponse")
}
...
type StorageAuthorityClient interface {
	...
	GetOrdersByAuthz(ctx context.Context, in *OrdersByAuthzRequest, opts ...grpc.CallOption) (*OrdersByAuthzResponse, error)
...
func (c *storageAuthorityClient) GetOrdersByAuthz(ctx context.Context, in *OrdersByAuthzRequest, opts ...grpc.CallOption) (*OrdersByAuthzResponse, error) {
	out := new(OrdersByAuthzResponse)
	err := grpc.Invoke(ctx, "/sa.StorageAuthority/GetOrdersByAuthz", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type StorageAuthorityServer interface {
	...
	GetOrdersByAuthz(context.Context, *OrdersByAuthzRequest) (*OrdersByAuthzResponse, error)
...
func _StorageAuthority_GetOrdersByAuthz_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(OrdersByAuthzRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(StorageAuthorityServer).GetOrdersByAuthz(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/sa.StorageAuthority/GetOrdersByAuthz",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StorageAuthorityServer).GetOrdersByAuthz(ctx, req.(*OrdersByAuthzRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _StorageAuthority_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetOrdersByAuthz",
			Handler:    _StorageAuthority_GetOrdersByAuthz_Handler,
		},
		{
...
var fileDescriptor0 = []byte{
	...
	,
}
